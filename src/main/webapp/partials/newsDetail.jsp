...
<div class="row-fluid sortable">
    ...
    <div id="comment" ng-controller="commentController">
        <div ng-repeat="item in data">
            <div class="page-header">
                <h1>{{item.comment}}</h1>
            </div>     
...
<textarea ng-model="comment.comment" ng-click='login()'></textarea>

</c:when>

<c:otherwise>
<textarea ng-model="comment.comment" ></textarea>
<button class="btn btn-info" ng-click="sendComment()">Send message</button>
